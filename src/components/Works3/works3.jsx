          ...
          <div className="row">
            <div className="col-lg-8 col-md-10">
              <div className="sec-head">
                ...
                We shed a light on our work &amp; <br />  what goes behind the development.
                </h3>
              </div>
            </div>
          </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="content">
                      <div className="img">
                        <span className="imgio">
                          <span className="wow cimgio" data-delay="500"></span>
                          <img src="/img/Untitled design (3).png" alt="" />
                        </span>
                      </div>
                      <div className="cont">
                        <h6>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="content">
                      <div className="img">
                        <span className="imgio">
                          <span className="wow cimgio" data-delay="500"></span>
                          <img src="/img/Untitled design (6).png" alt="" />
                        </span>
                      </div>
                      <div className="cont">
                        <h6>
